...
string nickname_usr1 = "John";
string nickname_usr2 = "Mike";
...
bool status_user1 = true;
bool status_user2 = false;
int tools;
int user;
bool usr2added;
bool usr1added;

void addusser1tocontac()
{
    if (phone_number_usr1 == enterednumber)
    {
        cout << "User was added to your contacts" << endl;
        usr1added = true;
    }
    else
    {
        cout << "User was not added to your contacts. Reason: incorecct phone number." << endl;
    }
    
}

void addusser2tocontac()
{
    if (phone_number_usr2 == enterednumber)
    {
        cout << "User was added to your contacts" << endl;
        usr2added = true;
    }
...
{
    if (usr2added != true)
        cout << "You cant send message if user is not your friend";
}
 ...
 */
    ...
    cout << "All users:" << endl;
    cout << "User1(John) - 1" << endl;
    cout << "User2(Mike) - 2" << endl;
    cout << "Choose user by typing his number: ";
    cin >> user;
    ...
    case 1:
    {
        cout << nickname_usr1 << endl;
        cout << "All tools:" << endl;
        cout << "Add User - 3" << endl;
        cout << "Send message - 4" << endl;
        cout << "Make audio call - 5" << endl;
        cout << "Make video call - 6" << endl;
        cout << "Make phone call - 7" << endl;
        cout << "Choose tool by typing his number: ";
        cin >> tools;
        switch (tools)
        {
        case 3:
        {
            cout << "If you want add user to contact you need to type his phone number: ";
            cin >> enterednumber;
            addusser2tocontac();
        }
        case 4:
